...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement('ALTER TABLE affecter_realjour_p_r ADD UNIQUE unique_affecter_realjour_p_r (idSemaine, idJour, idSalle, idSeance, matricule(50), idModule, codeGroupePR(50));');
    }
