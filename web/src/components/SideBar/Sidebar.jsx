        ...
        <div className="top">
          ...
          <div className="menu">
            <nav>
              ...
              <Link to={'/formateurs'} className="menu-item">
              ...
              <Link to={'/groupes'} className="menu-item">
              ...
              <Link to={'/modules'} className="menu-item">
              ...
              <Link to={'/filieres'} className="menu-item">
              ...
              <Link to={'/optionfilieres'} className="menu-item">
              ...
              <Link to={"/affectation"} className="menu-item">  
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pass icon" viewBox="0 0 16 16">
              ...
              <a href="/#" className="menu-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-calendar3 icon" viewBox="0 0 16 16">
              ...
              <a href="/#" className="menu-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-clock icon" viewBox="0 0 16 16">
                <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71z"/>
                <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0"/>
              </svg>
                Masses horaires
              </a>
              <Link to={"/planification"} className="menu-item"> 
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bar-chart-steps icon" viewBox="0 0 16 16">
