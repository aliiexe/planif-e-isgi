                    ...
                    <nav>
                        <a href="#" className="menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 className="bi bi-columns-gap icon" viewBox="0 0 16 16">
                                <path
                        ...
                        <Link to="/formateurs" className="menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 className="bi bi-person-video3 icon" viewBox="0 0 16 16">
                                <path
                        ...
                        <Link to={'/groupes'} className="menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 className="bi bi-people-fill icon" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="#" className="menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 className="bi bi-collection icon" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="#" className="menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 className="bi bi-gear-fill icon" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="/#" className="menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 className="bi bi-pass icon" viewBox="0 0 16 16">
                        ...
                        <a href="/#" className="menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 className="bi bi-calendar3 icon" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="/#" className="menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 className="bi bi-clock icon" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="/#" className="menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 className="bi bi-bar-chart-steps icon" viewBox="0 0 16 16">
                                <path
                ...
                <div className="user-info">
                    ...
                    <a href="#" className="logout">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                             stroke="currentColor" className="logout-icon">
